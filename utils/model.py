...
class Model:
    ...
    def setup_cnn(self) -> None:
        ...
        stride_vals = pool_vals = [(2, 2), (2, 2), (1, 2),
                                   (1, 2), (1, 2)]
        ...
        for i in range(num_layers):
            kernel = tf.Variable(
                tf.random.truncated_normal([kernel_vals[i],
                                            kernel_vals[i],
                                            feature_vals[i],
                                            feature_vals[i + 1]],
                                           stddev=0.1))
            ...
            conv_norm = layers.batch_normalization(conv,
    ...
    def setup_rnn(self) -> None:
        ...
        kernel = tf.Variable(tf.random.truncated_normal([1,
                                                         1, num_hidden * 2,
